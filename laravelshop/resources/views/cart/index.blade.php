                                    ...
                                    <tr>
                                       ...
                                       <td class="product-thumbnail">
                                          <div class="pro-thumbnail-img">
                                             <img src={{ URL::to('/') }}/images/product/{{$value->options->img}} alt="">
                                          </div>
                                          <div class="pro-thumbnail-info text-left">
                                             <h6 class="product-title-2">
                                                <a href="#">{!! str_limit($value->name, $limit = 30, $end = '...')  !!}</a>
                                             </h6>
                                             <p>Xuất xứ: {{ $value->options->trademark }}</p>
                                             <p> Màu sắc: Đen, Trắng</p>
                                          </div>
                                       </td>
                                       <td class="product-price">{{ number_format($value->price) }}</td>
                                       <td class="product-quantity">
                                          <div class="cart-plus-minus f-left update-cart"  data-qty = "{{ $value->qty }}" data-id="{{$value->rowId}}">
                                             <input type="text" value="{{ $value->qty }}" name="qtybutton" class="cart-plus-minus-box  qty-product" data-id="{{$value->rowId}}">
                                          </div>
                                       </td>
                                       <td class="product-subtotal  update-total{{$value->rowId}}">{{ number_format($value->subtotal) }}VNĐ</td>
                                       <td class="product-remove">
                                         <button class="delete" data-id="{{$value->rowId}}"><i class="zmdi zmdi-close"  title="Xóa sản phẩm"></i></button>
                                       </td>
                                    </tr>
                                    @endforeach
                                    <!-- tr -->
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="coupon-discount box-shadow p-30 mb-50">
                                    <h6 class="widget-title border-left mb-20">phiếu giảm giả</h6>
                              ...
                              <div class="col-md-6">
                                 <div class="payment-details box-shadow p-30 mb-50">
                                    ...
                                    <table>
                                       <tr>
                                          <td class="td-title-1">Tổng đơn hàng</td>
                                          <td class="td-title-2">{{ number_format($price)}} VNĐ</td>
                                       </tr>
                                       <tr>
                                          <td class="td-title-1">Phí vận chuyển</td>
                                          <td class="td-title-2">{{ number_format(50000) }} VNĐ</td>
                                       </tr>
                                       <tr>
                                       ...
                                       <tr>
                                          ...
                                          <td class="order-total-price">{{ number_format($price + 50000)}} VNĐ</td>
                                       </tr>
                                    </table>
                                 </div>
                                 <button class="submit-btn-1 mt-30 btn-hover-1 listcart"><a href="/" >Tiếp tục mua hàng</a></button>
                                 <button  class="submit-btn-1 mt-30 btn-hover-1 listcart" ><a href="cart/checkout" >Tiến hành thanh toán</a></button>
                              </div>
                           </div>
                        <!-- </form> -->
                     </div>
